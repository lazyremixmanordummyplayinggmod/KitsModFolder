    ...
    if name == "newArrowToggler" then
        if script then
            ...
            elseif value1 == 91 then
                lk = false
                cancelTween('nAdefaultOpponentStrumX0');
                cancelTween('nAdefaultOpponentStrumX1');
                cancelTween('nAdefaultOpponentStrumX2');
                cancelTween('nAdefaultOpponentStrumX3');
                cancelTween('nAdefaultOpponentStrumY0');
                cancelTween('nAdefaultOpponentStrumY1');
                cancelTween('nAdefaultOpponentStrumY2');
                cancelTween('nAdefaultOpponentStrumY3');
                cancelTween('nAdefaultPlayerStrumX0');
                cancelTween('nAdefaultPlayerStrumX1');
                cancelTween('nAdefaultPlayerStrumX2');
                cancelTween('nAdefaultPlayerStrumX3');
                cancelTween('nAdefaultPlayerStrumY0');
                cancelTween('nAdefaultPlayerStrumY1');
                cancelTween('nAdefaultPlayerStrumY2');
                cancelTween('nAdefaultPlayerStrumY3');
                cancelTween('nAhp');
                cancelTween('nAhpI1');
                cancelTween('nAhpI2');
                cancelTween('nAo1');
