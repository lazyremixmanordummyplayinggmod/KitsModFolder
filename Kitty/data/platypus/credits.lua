local people = {
    ...
    'Dan Povenmire | Jeff Marsh', -- Animator
    'Danny Jacob' -- Composer
}

local credits = {
    'gameplayborder', 'gameplaybg', 'gameplaytext', 'gameplayperson', 'animationborder', 'animationbg', 'animationtext', 'animationperson', 'composerborder', 'composerbg', 'composertext', 'composerperson'
}
...
function onCreate()
    ...
    if getProperty("animationtext.width") < getProperty("animationperson.width") then
        ...
        luaGraphic('animationbg', 5, 655, getTextWidth("animationtext"), 60, '000000')
    end
    luaGraphic('animationborder', 0, 650, getProperty("animationbg.width")+10, 70, 'ffff00')
    setObjectOrder("animationborder", 1)
    setObjectOrder("animationbg", 2)
    setObjectOrder("animationtext", 3)
    setObjectOrder("animationperson", 4)

    luaText('composerperson', 5, 615, 23, 'ffffff', '000000', people[3])
    luaText('composertext', 5, 585, 23, 'ff0000', '000000', 'Medley')
