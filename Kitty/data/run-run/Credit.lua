...
function onCreate()
	...
	if #roleCredits[roleCreditSelected].artists[1]*25 < minLength then
		luaGraphic('creditsGraphicCa', -minLength-(150+roleCredits[roleCreditSelected].artists[3][1]), getProperty('creditsGraphicBa.y')+getProperty('creditsGraphicBa.height'), minLength, 90, roleCredits[roleCreditSelected].barBG[2])
	else
		luaGraphic('creditsGraphicCa', (-#roleCredits[roleCreditSelected].artists[1]*25)-(150+roleCredits[roleCreditSelected].artists[3][1]), getProperty('creditsGraphicBa.y')+getProperty('creditsGraphicBa.height'), #roleCredits[roleCreditSelected].artists[1]*25, 90, roleCredits[roleCreditSelected].barBG[2])
	end
	luaGraphic('creditsGraphicCb', getProperty('creditsGraphicCa.x'), getProperty('creditsGraphicCa.y')+5, getProperty('creditsGraphicCa.width')-5, getProperty('creditsGraphicCa.height')-10, roleCredits[roleCreditSelected].barFG[2])
	luaText('creditsTextCa', getProperty('creditsGraphicCb.x')+5, getProperty('creditsGraphicCb.y')+3, 30, '000000', 'FFFFFF', 'Art:')
	luaText('creditsTextCb', getProperty('creditsGraphicCb.x')+5, getProperty('creditsGraphicCb.y')+35, 40, roleCredits[roleCreditSelected].textColor[2], roleCredits[roleCreditSelected].textBorderColor[2], roleCredits[roleCreditSelected].artists[1])
	...
	if #roleCredits[roleCreditSelected].composers[1]*25 < minLength then
		luaGraphic('creditsGraphicDa', -minLength-(150+roleCredits[roleCreditSelected].composers[3][1]), getProperty('creditsGraphicCa.y')+getProperty('creditsGraphicCa.height'), minLength, 90, roleCredits[roleCreditSelected].barBG[3])
	else
		luaGraphic('creditsGraphicDa', (-#roleCredits[roleCreditSelected].composers[1]*25)-(150+roleCredits[roleCreditSelected].composers[3][1]), getProperty('creditsGraphicCa.y')+getProperty('creditsGraphicCa.height'), #roleCredits[roleCreditSelected].composers[1]*25, 90, roleCredits[roleCreditSelected].barBG[3])
	end
	luaGraphic('creditsGraphicDb', getProperty('creditsGraphicDa.x'), getProperty('creditsGraphicDa.y')+5, getProperty('creditsGraphicDa.width')-5, getProperty('creditsGraphicDa.height')-10, roleCredits[roleCreditSelected].barFG[3])
	luaText('creditsTextDa', getProperty('creditsGraphicDb.x')+5, getProperty('creditsGraphicDb.y')+3, 30, '000000', 'FFFFFF', 'Music:')
	luaText('creditsTextDb', getProperty('creditsGraphicDb.x')+5, getProperty('creditsGraphicDb.y')+35, 40, roleCredits[roleCreditSelected].textColor[3], roleCredits[roleCreditSelected].textBorderColor[3], roleCredits[roleCreditSelected].composers[1])
